    ...
    <body>
        ...
        <nav class="main">
            ...
            <div class="page_header">               
                <h2>View Form-Provide Below Details</h2>
            </div>
            <div id="registration_form_area">
                <div id="message_div">${message}</div>
                <form method="post" name="registration_form" action="ManageView">
                    <table>
                        <tr>
                            <td class="headline">View ID : </td>                                    
                            <td class="valueFields"><input type="text" name="txtVID" id="txtVID" class="fields" readonly="readonly" value="${vID}"></td>
                        ...
                        <tr>
                            ...
                            <td class="valueFields"><input type="date" name="txtDate" id="txtDate" class="fields">
                        <tr>
                            <td class="headline">Time* : </td>                                  
                            <td class="valueFields"><input type="time" name="txtTime" id="txtTime" class="fields"></td>                          
                        </tr>              
