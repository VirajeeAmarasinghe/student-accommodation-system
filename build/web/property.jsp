        ...
        <div id="registration_form" class="registration_form">
            ...
            <div id="registration_form_area">
                ...
                <%
                    ...
                    int pID = propertyDAO.getNxtId();;
                %>
                <form method="post" name="registration_form" action="MngProp" enctype="multipart/form-data">
                    <table> 
                        <tr>
                            <td class="headline">Property ID* : </td>                                    
                            <td class="valueFields"><input type="text" name="txtID" id="txtID" value="<%=pID%>" class="fields" readonly="readonly"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="submit" name="btnEditAvilability" value="Make Unavailable" class="buttons"></td>
                        </tr>
                        <tr>
