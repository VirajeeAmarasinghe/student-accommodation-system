...
public class DisplayPayments extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String message="";
        String url="/viewAllPayment.jsp";
        
        PaymentDAO pDAO=new PaymentDAO();
        ArrayList<Payment> payementList=null;
        
        try {
            payementList=pDAO.getPayments(lID);
            if(payementList.isEmpty()){
                message="No Payments";
                request.setAttribute("visibility","no");
            }
            request.setAttribute("paymentList", payementList);
        } catch (Exception e) {
            url="/error.jsp";
